...
% * <stefaniejacinto@gmail.com> 2016-04-17T18:11:30.984Z:
%
% > The paper is organized as follows: In Section~\ref{bg} we describe the matching task and the evaluation criteria in mathematical notations. The proposed nonlinear manifold matching algorithm is presented in Section~\ref{main1}, with various implementation issues discussed in Section~\ref{discuss}. In Section~\ref{numer}, we illustrate the advantages of our algorithm via numerical simulations and real data experiments, using the simulated Swiss roll simulation and the Wikipedia document data sets with text and graph features. Finally, we summarize the results in Section~\ref{conclu}.
%
% Is this section really necessary?
%
% ^ <joshuav@gmail.com> 2016-04-28T01:13:54.693Z:
%
% i think never useful.
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:38:00.521Z:
%
% if you mean the conclusion section, no, it is not necessay.
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:49:20.843Z.
...
% * <stefaniejacinto@gmail.com> 2016-04-17T18:13:05.214Z:
%
% > we focus mainly on matching two data set
%
% Confirm with client
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:41:56.994Z:
%
% correct & changed for clarity.
%
% ^ <joshuav@gmail.com> 2016-05-01T18:19:37.274Z.
...
% * <stefaniejacinto@gmail.com> 2016-04-17T18:22:16.062Z:
%
% > percentage
%
% Probability?
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:40:41.666Z:
%
% yeah I think probability is more appropriate.
%
% ^ <joshuav@gmail.com> 2016-05-01T18:19:58.821Z.
...
Algorithm~\ref{alg2} is similar to algorithm~\ref{alg1}, except joint neighborhood is not used for testing observations of unknown correspondence; and algorithm~\ref{alg2} is applicable to testing data of arbitrary size, but for simplicity we present it for one testing observation from each data source.
...
% ^ <cshen6@jhu.edu> 2016-04-29T12:43:15.967Z:
%
% correct and changed for clarity.
%
% ^.
...
% * <stefaniejacinto@gmail.com> 2016-04-17T18:33:53.091Z:
%
% > pros and cons
%
% Too casual? Maybe we can use "advantages and disadvantages" instead?
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:44:26.094Z:
%
% changed accordingly
%
% ^ <joshuav@gmail.com> 2016-05-01T18:20:09.784Z.
...
% * <stefaniejacinto@gmail.com> 2016-04-17T18:40:51.608Z:
%
% > For the first simulation
%
% Here the author shifts from using past tense to using present tense for the rest of the paper. Was there a specific reason for that?
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:53:29.714Z:
%
% I thought I used present tense for most parts of it; will check all past tense and change to present accordingly
%
% ^ <joshuav@gmail.com> 2016-05-01T18:21:07.141Z:
%
% @cencheng - let us know when you think you've converged on a tense, so we can check.  should be all present i think.
%
% ^ <cshen6@jhu.edu> 2016-05-03T12:40:58.561Z:
%
% I checked that I never used past tense throughout the paper, I think...
%
% ^ <joshuav@gmail.com> 2016-05-16T01:51:59.347Z.
...
% * <stefaniejacinto@gmail.com> 2016-04-17T18:46:20.789Z:
%
% > for every two data sets matching combination
%
% This needs rewording but I don't understand the phrase. Need to ask client.
%
% ^ <cshen6@jhu.edu> 2016-04-29T12:46:17.343Z:
%
% Clarified in tex. Since there are 4 data sets in total, matching any two of them means there are 6 possible combinations. 
%
% ^ <joshuav@gmail.com> 2016-05-16T01:52:09.677Z.
